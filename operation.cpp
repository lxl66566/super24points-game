...
operation::operation(operations op, std::function<f64 (f64, f64)> func, QPushButton *button)
...
std::variant<f64, QString> operation::dynamic_func(std::variant<f64, QString> x,f64 y)
{
    try {
